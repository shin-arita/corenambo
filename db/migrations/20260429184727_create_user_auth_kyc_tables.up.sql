...
CREATE TABLE user_emails (
                             ...
                             created_at timestamptz NOT NULL DEFAULT NOW(),
                             updated_at timestamptz NOT NULL DEFAULT NOW(),
                             CONSTRAINT chk_user_emails_primary_requires_verified
...
CREATE UNIQUE INDEX user_emails_user_id_unique_idx
...
COMMENT ON COLUMN user_verifications.provider IS '本人確認サービス提供元。自前保存ではなく外部eKYCサービスを使用する';
